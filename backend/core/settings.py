...
DEBUG = config('DEBUG', default=False, cast=bool)  # Режим отладки
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1').split(',') # Разрешённые хосты
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='cloud_storage'),
...
STORAGE_ROOT = config('STORAGE_ROOT', default=os.path.join(MEDIA_ROOT, 'storage'))
